...
<<<<<<< TODO: Unmerged change from project 'Paper(net8.0)', Before:
...
public sealed partial class PaperDevTools
{
    ...
    private sealed class Node
    {
        ...
        public LayoutType Lay;
        public PositionType Pos;
        public required string Text, Handlers, Draw;
    }
...
public sealed partial class PaperDevTools
{
    ...
    private int Walk(ElementHandle h, int depth, int parentSnap)
    {
        ...
        var n = new Node
        {
            ...
            TabIndex = d.TabIndex,
            Visible = d.Visible,
            Scissor = d._scissorEnabled,
            Lay = d.LayoutType,
            Pos = d.PositionType,
            Text = TextPreview(ref d),
            Handlers = HandlerString(ref d),
            Draw = ComputeDrawKind(ref d),
        };
        int idx = _snap.Count;
        _snap.Add(n);
        _idToSnap[d.ID] = idx;
