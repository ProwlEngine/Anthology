...
internal static class PolylineMesher
{
    ...
    [ThreadStatic] private static required List<Float2> _points;
    [ThreadStatic] private static required List<Float2> _normals;
    [ThreadStatic] private static required List<float> _segLenSqr;
    [ThreadStatic] private static required List<Arc> _arcs;
    [ThreadStatic] private static required List<Vertex> _vtx;
    [ThreadStatic] private static required List<uint> _idx;
